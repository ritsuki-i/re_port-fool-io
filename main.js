...
const init = () => {
  ...
  const geometry10 = new THREE.BoxGeometry(90, 90, 90);
  ...
  let material10 = [
    new THREE.MeshBasicMaterial({ map: loadPic.load('img/piedpiper.png') }),
    new THREE.MeshBasicMaterial({ map: loadPic.load('img/piedpiper.png') }),
    new THREE.MeshBasicMaterial({ map: loadPic.load('textures/side.jpeg') }),
    new THREE.MeshBasicMaterial({ map: loadPic.load('textures/side.jpeg') }),
    new THREE.MeshBasicMaterial({ map: loadPic.load('textures/side.jpeg') }),
  ...
  earthMesh10.position.set(-90, -200, 200);
  ...
  function tick() {
    ...
    earthMesh10.rotation.x -= 10.001;
    earthMesh10.rotation.y -= 0.001;
    earthMesh10.rotation.z -= 0.001;
    // レンダリング
